...
style_description requires aesthetics, lighting, medium, and exactly one separate style-mode field named photo or art_style. The medium field never replaces the style-mode field, even if its value is "photo". A photographic object uses aesthetics, lighting, photo, medium, then optional color_palette. A non-photographic object uses aesthetics, lighting, medium, art_style, then optional color_palette. Never include both photo and art_style.
